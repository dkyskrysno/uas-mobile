...
class ListHeroAdapter(private val context: Context, private val listHero: ArrayList<Motocycle>) : RecyclerView.Adapter<ListHeroAdapter.ListViewHolder>() {
    private lateinit var onItemClickCallback: OnItemClickCallback
    private var mediaPlayer: MediaPlayer? = null

    init {

        mediaPlayer = MediaPlayer.create(context, R.raw.satu)
    }
    ...
    interface OnItemClickCallback {
        fun onItemClicked(data: Motocycle)
    }
}
